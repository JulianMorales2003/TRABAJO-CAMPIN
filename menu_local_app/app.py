...
def index():
    ...
    return render_template("index.html", menu=menu, pedido=pedido_actual, total=total,
                           historial=historial, efectivo=efectivo, datafono=datafono)
